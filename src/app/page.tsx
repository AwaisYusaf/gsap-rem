    ...
    <main className='min-h-screen w-full' id="root">
      ...
      <div className='flex justify-center space-x-2 mx-auto max-w-xl mb-4 px-4'>
        <input placeholder='Enter your email'
          className='lg:basis-7/12 basis-1/2 lg:py-4 md:py-3 py-2 px-5 text-base outline-none border border-black rounded-lg focus-within:ring-1 ring-[#8E33FF]' />
        <button
          className='flex justify-center items-center space-x-2 text-white basis-1/2 rounded-lg lg:py-4 md:py-3 py-2 hover:opacity-90 bg-[#8E33FF]'>
